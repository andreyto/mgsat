...
#'Copied from https://github.com/mgahan/boRingTrees
#' 
...
#'data[,Roll:=rolling.window.irreg(data=data,bylist="Cust_ID",dates="Trans_Dates",
...
rolling.window.irreg <- function(data,bylist=NULL,dates,target=NULL,
